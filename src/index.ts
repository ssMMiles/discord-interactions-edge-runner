...
export default async function handleFetch(request: Request, env: Env, ctx: ExtendableEvent): Promise<Response> {
  ...
  try {
    const [getResponse, handling] = await app.handleInteraction(body, false);
